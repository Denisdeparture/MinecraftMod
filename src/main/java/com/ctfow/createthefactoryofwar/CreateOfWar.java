...
@Mod(CreateOfWar.MODID)
public class CreateOfWar {
    public static final String MODID = "createthefactoryofwar";
    ...
    public CreateOfWar(IEventBus modEventBus, ModContainer modContainer) {
